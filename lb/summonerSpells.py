...
def getInfo():
    url = 'https://ddragon.leagueoflegends.com/cdn/12.1.1/data/en_US/summoner.json'
...
def createIdToImageUrl(info):
    ...
    for summoner in info['data'].keys():
        res[info['data'][summoner]['key']] = 'http://ddragon.leagueoflegends.com/cdn/8.11.1/img/spell/' +info['data'][summoner]['image']['full']
    return res
